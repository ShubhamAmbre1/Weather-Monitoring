...
String AP = "Virus.exe";       // put your wifi name here
String PASS = "14486492"; // put your wifi password here
String API = "RNUUKXZAQ23W710P";   // put the API key from things speak , "Write API KEY"
